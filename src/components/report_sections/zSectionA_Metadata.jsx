  ...
  return (
    <section>
      <div className="grid grid-cols-12 gap-3">
        ...
        <div className="col-span-12 md:col-span-4 md:row-span-2 h-full">
          <label className="block text-xs">Image</label>
          <div onDrop={onDrop} onDragOver={(e) => e.preventDefault()} className="h-32 md:h-[152px] rounded-md border border-slate-600 bg-slate-900 grid place-items-center text-sm">
        ...
        {/* Row 2 MGRS results */}
        <div className="col-span-12 md:col-span-4 md:row-start-2 h-full">
          <label className="block text-xs">MGRS Results</label>
          <div className="h-40 overflow-auto rounded-md border border-slate-700 bg-slate-900">
